...
export function CreativePanel({ workspace }: Props) {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : 'Error al cargar Creativos');
    } finally {
      setLoading(false);
    }
  }, [workspace]);
                ...
                <div className="mt-4 grid gap-2 text-sm text-slate-300 sm:grid-cols-2">
                  <p>
                    ...
                    <span className="text-white">
                      ...
                      {selected.assets[0] ? `:v${selected.assets[0].templateVersion}` : ''}
                    </span>
                  </p>
                  <p>
                    Formato:{' '}
                    <span className="text-white">
                      {selected.assets[0]?.format || plan?.format || '—'}
                    </span>
                  </p>
                  <p>
